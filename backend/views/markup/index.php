...
/* @var $searchModel backend\models\search\MarkupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '加价设置';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="markup-index grid-view box box-primary">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'class' => 'kartik\grid\EditableColumn',
                'attribute' => 'markup_ratio',
                'value' => function ($model, $key, $index, $column) {
                    return $model->markup_ratio.'%';
                }
            ],
            [
                ...
                'value' => function ($model, $key, $index, $column) {
                    return Markup::getTypeOptions($model->type);
                }
            ],
            [
                'class' => '\kartik\grid\DataColumn',
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filterWidgetOptions' => [
                    'data' => Markup::getStatusOptions(),
                    'options' => [
                        'prompt' => Yii::t('common', 'Please Select...'),
                    ],
                ],
                'value' => function ($model, $key, $index, $column) {
                    return Markup::getStatusOptions($model->status);
                }
            ],
            'sort',
            // 'created_by',
